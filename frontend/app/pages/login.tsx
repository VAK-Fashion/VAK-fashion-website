...
const Login = () => {
    ...
    const SMB = (e: any) => {
        e.preventDefault();
        api.Login(from).then(r => {
            console.log(r.error.error.length !== 0 || r.error)
            if (
                r.error.error.length !== 0 || r.error
            ) {
                setErr(r.error.error[0]);
            ...
            <div className={style.h}>
                ...
                <div className={style.formCon}>
                    <form onSubmit={SMB} className={style.form}>
                        ...
                        <samp className={style.sam}>Not registed yet? <Link href="/signup">Create an Account</Link> </samp>
                    </form>
