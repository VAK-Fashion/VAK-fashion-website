                        ...
                        <div className="sidebar_tags">
                            ...
                            <div className="sidebar_widget filterBox filter-widget size-swacthes">
                                ...
                                <div className="filter-color swacth-list">
                                    <ul>
                                        {["X", "XL", "XLL", "M", "L", "S", "XXXL", "XXL", "XS"].map((v, i) => (
                                            <li key={i}>
                        ...
                        <div className="productList">
                            ...
                            <div className="grid-products grid--view-items">
                                <Row>
                                    {[{
                                        image: {
                                            _1: 'assets/images/product-images/product-image1.jpg',
                                            _2: 'assets/images/product-images/product-image1-1.jpg',
                                        },
                                        label: {
                                            new: true,
                                            onSale: '-16%'
                                        ...
                                        <Col key={i} sm="6" md="4" lg="3" className={`col-6 grid-view-item style2 item ${v.product.soldOut ? 'grid-view-item--sold-out' : ''}`}>
                                            <div className="grid-view_image">
                                                <Link to={'/Product/' + v.product.name} className="grid-view-item__link">
                                                    <img className="grid-view-item__image primary blur-up lazyload" data-src={v.image._1} src={v.image._1} alt={v.product.name} title={v.product.name} />
                                                    <img className="grid-view-item__image hover blur-up lazyload" data-src={v.image._2} src={v.image._2} alt={v.product.name} title={v.product.name} />
                                                    <div className="product-labels rectangular">
                                                        {v.label.onSale !== '' ? <span className="lbl on-sale">{v.label.onSale}</span> : null}
                                                        {v.label.new ? <span className="lbl pr-label1">new</span> : null}
                                                    </div>
                                                    {v.product.soldOut ? <span className="sold-out"><span>Sold out</span></span> : null}

                                                </Link>
                                                <div className="product-details hoverDetails  text-center mobile">
                                                    <div className="product-name">
                                                        <Link to={'/Product/' + v.product.name}>{v.product.name}</Link>
                                                    </div>
                                                    <div className="product-price">
                                                        <span className="old-price">{v.product.Price.old}</span>
                                                        <span className="price">{v.product.Price.price}</span>
                                                    </div>
                                                    {!v.product.soldOut ? <div className="button-set">
                                                        <Link to={'/Product/' + v.product.name} className="quick-view-popup quick-view">
                                                        ...
                                                        <div className="wishlist-btn">
                                                            <Link className="wishlist add-to-wislist" to="#">
